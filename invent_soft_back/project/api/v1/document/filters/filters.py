...
class DocumentFilterSet(FilterSet):  # noqa: WPS214
    ...
    counter_scan_barcode_amount_eq = NumberFilter(method='counter_scan_barcode_amount_eq_meth')
    counter_scan_barcode_amount_not_eq = NumberFilter(method='counter_scan_not_eq_meth')
    counter_scan_barcode_amount_more_than = NumberFilter(method='counter_scan_more_than_meth')
    counter_scan_barcode_amount_less_than = NumberFilter(method='counter_scan_less_than_meth')

    controller_barcode_amount_eq = NumberFilter(method='controller_eq_meth')
    controller_barcode_amount_not_eq = NumberFilter(method='controller_not_eq_meth')
    controller_barcode_amount_more_than = NumberFilter(method='controller_more_than_meth')
    controller_barcode_amount_less_than = NumberFilter(method='controller_less_than_meth')
    ...
    def counter_scan_barcode_amount_eq_meth(self, queryset, name, value):
        return DocumentFilterSetService().counter_scan_barcode_amount_eq_meth(queryset, name, value)
