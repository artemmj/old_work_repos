...
class SignInspectorCreateSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        try:
            ...
            raise ValidationError({
                'inspection': config.INSPECTION_IMPOSSIBLE_BIND_INSPECTOR_SIGN_ERROR,
            })
        return instance


class SignInspectorRetrieveSerializer(serializers.ModelSerializer):
