...
class ArraySelectMultiple(SelectMultiple):
    ...
    def value_omitted_from_data(self, data, files, name):  # noqa: WPS110
        return False
...
class ChoiceArrayField(ArrayField):
    ...
    def to_python(self, value):    # noqa: WPS110
        ...
        if isinstance(res, list):
            value = [self.base_field.to_python(val) for val in res]   # noqa: WPS110
        return value

    def validate(self, value, model_instance):  # noqa: WPS110
