...
from api.v1.document.filters.filters import DocumentFilterSet, DocumentScannedProductsFilterSet
...
from api.v1.document.serializers import (  # noqa: WPS235
    ...
    DocumentScannedProductsReadSerializer,
...
from apps.helpers.viewsets import (
    ListRetrieveCreateUpdateExtendedModelViewSet,
    ListRetrieveUpdateExtendedModelViewSet,
    paginate_response,
)
...
class DocumentViewSet(ListRetrieveCreateUpdateExtendedModelViewSet):  # noqa: WPS214
    ...
    ordering_fields = (
        ...
        'auditor_barcode_amount',
        'auditor_controller_barcode_amount',
        'start_audit_date',
        'end_audit_date',
        'tsd_number',
    ...
    def batch_status_inverting(self, request):
        ...
        BatchStatusInvertingService(documents=documents).process()
...
class DocumentScannedProductsViewSet(ListRetrieveUpdateExtendedModelViewSet):
    queryset = ScannedProduct.objects.with_number_idx().with_displayed_dm().order_by('number')
    serializer_class = DocumentScannedProductsReadSerializer
    ...
    filterset_class = DocumentScannedProductsFilterSet
