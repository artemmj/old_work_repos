...
from .document.views import DocumentScannedProductsViewSet, DocumentViewSet
...
router.register('document_scanned_products', DocumentScannedProductsViewSet, basename='document_scanned_products')
