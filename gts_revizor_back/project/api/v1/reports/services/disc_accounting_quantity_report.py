...
class DiscAccountingQuantityReportService(BaseReportService):  # noqa: WPS338
    ...
    def _create_context(self):  # noqa: WPS231
        ...
        products = GetProductsForReportsService(project=self.project).process()
        ...
        for product in products:
            ...
            source_data[product] = {
                ...
                'title': MergeProductTitleAndTitleAttrsService(
                    additional_title_attrs=product.additional_title_attrs,
                    hidden_title_attrs=product.hide_title_attrs,
        ...
        for product in source_data.keys():
            ...
            context['products'].append({
                ...
                'title': source_data[product]['title'],
                'vendor_code': vendor_code,
                'zone': zones,
