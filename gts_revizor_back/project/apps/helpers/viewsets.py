...
class ListUpdateExtendedModelViewSet(
    ExtendViewSet,
    mixins.ListModelMixin,
    mixins.UpdateModelMixin,
    viewsets.GenericViewSet,
...
class ListCreateExtendedModelViewSet(
    ExtendViewSet,
    mixins.ListModelMixin,
    mixins.CreateModelMixin,
    viewsets.GenericViewSet,
...
class ListCreateUpdateExtendedModelViewSet(
    ExtendViewSet,
    mixins.ListModelMixin,
    mixins.CreateModelMixin,
    mixins.UpdateModelMixin,
...
class ListCreateRetrieveExtendedModelViewSet(
    ExtendViewSet,
    mixins.ListModelMixin,
    mixins.CreateModelMixin,
    mixins.RetrieveModelMixin,
...
class UpdateExtendedModelViewSet(
    ExtendViewSet,
    mixins.UpdateModelMixin,
    viewsets.GenericViewSet,
):
...
class ListRetrieveUpdateExtendedModelViewSet(
    ExtendViewSet,
    mixins.ListModelMixin,
    mixins.RetrieveModelMixin,
    mixins.UpdateModelMixin,
...
class ListRetrieveCreateUpdateExtendedModelViewSet(
    ExtendViewSet,
    mixins.ListModelMixin,
    mixins.CreateModelMixin,
    mixins.RetrieveModelMixin,
