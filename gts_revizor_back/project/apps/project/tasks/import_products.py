        ...
        for chunk in self._chunks(memory_data, CHUNK_SIZE):
            ...
            for product_data in chunk:
                ...
                if exist_products:
                    ...
                    remainder_2 = 0
                    if product_data.get('remainder_2'):
                        remainder_2 = product_data.get('remainder_2').replace(',', '.')
                    ...
                    if product_data.get('am', False):
                        new_product_data['am'] = product_data.get('am')
                    if product_data.get('dm', False):
                        new_product_data['dm'] = product_data.get('dm')
                    if product_data.get('store_number', False):
                        new_product_data['store_number'] = product_data.get('store_number')
