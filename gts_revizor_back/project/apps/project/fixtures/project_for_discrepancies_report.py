...
@pytest.fixture()
def project_for_discrepancies_report(
    project,
    products_factory,
    ...
    """Фикстура создания проекта для отчета L&G сличительная (Ведомость расхождений)."""
    zones = zones_factory(
        count=3,
        project=project,
    ...
    products = products_factory(
        ...
        vendor_code=(vendor_code for vendor_code in ['', '111', '000']),
    )
    scanned_products_factory(
        count=3,
