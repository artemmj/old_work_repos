...
def test_write_doc_zone_first(project_for_export_doc_zone_first, templates_export_factory):
    ...
    with open(filepath, encoding='windows-1251') as ifile:
        # zone_1; 1; 1111; Первый;       qqq; 10.000; 9;  -1;   -1.000;  500.0
        # zone_1; 1; 1111; Первый;       qqq; 10.000; 9;  -1;   -1.000;  500.0
        # zone_2; 2; 2222; Второй;       www; 20.000; 0;  -20;  -20.000; 500.0
        # zone_2; 2; 2222; Второй;       www; 20.000; 0;  -20;  -20.000; 500.0
        # zone_3; 3; 3333; Неизвестный;  eee; 30.000;  35;  5;   5.000;   500.0
        # zone_3; 3; 3333; Неизвестный;  eee; 30.000; 35;  5;   5.000;   500.0
        lines = ifile.readlines()
        assert lines[0].split(';')[0] == 'zone_1'
        assert lines[0].split(';')[1] == '1'
        assert lines[1].split(';')[0] == 'zone_1'
        assert lines[1].split(';')[1] == '1'
        assert lines[2].split(';')[0] == 'zone_2'
        assert lines[2].split(';')[1] == '2'
        assert lines[3].split(';')[0] == 'zone_2'
        assert lines[3].split(';')[1] == '2'
        assert lines[4].split(';')[0] == 'zone_3'
        assert lines[4].split(';')[1] == '3'
        assert lines[5].split(';')[0] == 'zone_3'
        assert lines[5].split(';')[1] == '3'
